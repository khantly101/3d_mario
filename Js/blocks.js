...
const initBlocks = () => {
	...
	const questionTop = new Physijs.BoxMesh(new THREE.PlaneGeometry(0.95, 1, 1, 1), new THREE.MeshPhongMaterial({transparent: true, opacity: 0}), 0)
	...
	const questionBottom = new Physijs.BoxMesh(new THREE.PlaneGeometry(0.95, 1, 1, 1), new THREE.MeshPhongMaterial({transparent: true, opacity: 0}), 0)
	...
	const copyQuestionTop = new Physijs.BoxMesh(new THREE.PlaneGeometry(0.95, 1, 1, 1), new THREE.MeshPhongMaterial({transparent: true, opacity: 0}), 0)
	...
	const copyQuestionBottom = new Physijs.BoxMesh(new THREE.PlaneGeometry(0.95, 1, 1, 1), new THREE.MeshPhongMaterial({transparent: true, opacity: 0}), 0)
	...
	const copyQuestion2Top = new Physijs.BoxMesh(new THREE.PlaneGeometry(0.95, 1, 1, 1), new THREE.MeshPhongMaterial({transparent: true, opacity: 0}), 0)
	...
	const copyQuestion2Bottom = new Physijs.BoxMesh(new THREE.PlaneGeometry(0.95, 1, 1, 1), new THREE.MeshPhongMaterial({transparent: true, opacity: 0}), 0)
	...
	const copyQuestion3Top = new Physijs.BoxMesh(new THREE.PlaneGeometry(0.95, 1, 1, 1), new THREE.MeshPhongMaterial({transparent: true, opacity: 0}), 0)
	...
	const copyQuestion3Bottom = new Physijs.BoxMesh(new THREE.PlaneGeometry(0.95, 1, 1, 1), new THREE.MeshPhongMaterial({transparent: true, opacity: 0}), 0)
	...
	const copyQuestion4Top = new Physijs.BoxMesh(new THREE.PlaneGeometry(0.95, 1, 1, 1), new THREE.MeshPhongMaterial({transparent: true, opacity: 0}), 0)
	...
	const copyQuestion4Bottom = new Physijs.BoxMesh(new THREE.PlaneGeometry(0.95, 1, 1, 1), new THREE.MeshPhongMaterial({transparent: true, opacity: 0}), 0)
	...
	const copyQuestion5Top = new Physijs.BoxMesh(new THREE.PlaneGeometry(0.95, 1, 1, 1), new THREE.MeshPhongMaterial({transparent: true, opacity: 0}), 0)
	...
	const copyQuestion5Bottom = new Physijs.BoxMesh(new THREE.PlaneGeometry(0.95, 1, 1, 1), new THREE.MeshPhongMaterial({transparent: true, opacity: 0}), 0)
	...
	const copyQuestion6Top = new Physijs.BoxMesh(new THREE.PlaneGeometry(0.95, 1, 1, 1), new THREE.MeshPhongMaterial({transparent: true, opacity: 0}), 0)
	...
	const copyQuestion6Bottom = new Physijs.BoxMesh(new THREE.PlaneGeometry(0.95, 1, 1, 1), new THREE.MeshPhongMaterial({transparent: true, opacity: 0}), 0)
	...
	const copyQuestion7Top = new Physijs.BoxMesh(new THREE.PlaneGeometry(0.95, 1, 1, 1), new THREE.MeshPhongMaterial({transparent: true, opacity: 0}), 0)
	...
	const copyQuestion7Bottom = new Physijs.BoxMesh(new THREE.PlaneGeometry(0.95, 1, 1, 1), new THREE.MeshPhongMaterial({transparent: true, opacity: 0}), 0)
	...
	const copyQuestion8Top = new Physijs.BoxMesh(new THREE.PlaneGeometry(0.95, 1, 1, 1), new THREE.MeshPhongMaterial({transparent: true, opacity: 0}), 0)
	...
	const copyQuestion8Bottom = new Physijs.BoxMesh(new THREE.PlaneGeometry(0.95, 1, 1, 1), new THREE.MeshPhongMaterial({transparent: true, opacity: 0}), 0)
	...
	const copyQuestion9Top = new Physijs.BoxMesh(new THREE.PlaneGeometry(0.95, 1, 1, 1), new THREE.MeshPhongMaterial({transparent: true, opacity: 0}), 0)
	...
	const copyQuestion9Bottom = new Physijs.BoxMesh(new THREE.PlaneGeometry(0.95, 1, 1, 1), new THREE.MeshPhongMaterial({transparent: true, opacity: 0}), 0)
	...
	const copyQuestion10Top = new Physijs.BoxMesh(new THREE.PlaneGeometry(0.95, 1, 1, 1), new THREE.MeshPhongMaterial({transparent: true, opacity: 0}), 0)
	...
	const copyQuestion10Bottom = new Physijs.BoxMesh(new THREE.PlaneGeometry(0.95, 1, 1, 1), new THREE.MeshPhongMaterial({transparent: true, opacity: 0}), 0)
	...
	const copyQuestion11Top = new Physijs.BoxMesh(new THREE.PlaneGeometry(0.95, 1, 1, 1), new THREE.MeshPhongMaterial({transparent: true, opacity: 0}), 0)
	...
	const copyQuestion11Bottom = new Physijs.BoxMesh(new THREE.PlaneGeometry(0.95, 1, 1, 1), new THREE.MeshPhongMaterial({transparent: true, opacity: 0}), 0)
	...
	const copyQuestion12Top = new Physijs.BoxMesh(new THREE.PlaneGeometry(0.95, 1, 1, 1), new THREE.MeshPhongMaterial({transparent: true, opacity: 0}), 0)
	...
	const copyQuestion12Bottom = new Physijs.BoxMesh(new THREE.PlaneGeometry(0.95, 1, 1, 1), new THREE.MeshPhongMaterial({transparent: true, opacity: 0}), 0)
	...
	const blankTop = new Physijs.BoxMesh(new THREE.PlaneGeometry(0.95, 1, 1, 1), new THREE.MeshPhongMaterial({transparent: true, opacity: 0}), 0)
	...
	const blankBottom = new Physijs.BoxMesh(new THREE.PlaneGeometry(0.95, 1, 1, 1), new THREE.MeshPhongMaterial({transparent: true, opacity: 0}), 0)
